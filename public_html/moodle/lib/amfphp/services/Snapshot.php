	...
	public function amf_save_snapshot($obj)
	{
		...
		*/
		...
		if ($capabilities->is_logged_in && $capabilities->view_own_grades)
		{
			...
			//} else
			//{
				// Build alternative path to course files directory and subdirectory /snapshots/99_Concept_map_activity/
				//$dataroot_path = $CFG->swf_dataroot.'/'.$capabilities->course.'/snapshots/'.$capabilities->cmid.'_'.$swf_dirname.'/';
				//$moodledata_path = $CFG->swf_wwwroot.'/'.$capabilities->course.'/snapshots/'.$capabilities->cmid.'_'.$swf_dirname.'/';
			//}
